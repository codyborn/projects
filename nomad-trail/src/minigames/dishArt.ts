...
function drawLayer(p: Px, v: Vessel, L: Layer, idx: number) {
  ...
  switch (L.s) {
    ...
    case 'bun': { // a flat-bottomed dome sitting on the patty: rows from the crown down to a flat base
      const rx = w / 2, ry = h; const base = cy + 1;
...
export const dishArtSpecs: Record<string, DishArtSpec> = {
  ...
  bisonburger: { vessel: 'plate', layers: [{ s: 'bunbottom', c: 'earth3', w: 18, y: 1 }, { s: 'patty', c: 'earth0', c2: 'earth1', w: 18, h: 3, y: -1 }, { s: 'sticks', c: 'sun1', n: 1, w: 20, y: -3 }, { s: 'ring', c: 'white', c2: 'white', w: 8, h: 2, y: -4 }, { s: 'bun', c: 'earth3', w: 18, h: 5, y: -5 }] },
  ...
  fishtacos: { vessel: 'boat', layers: [{ s: 'mound', c: 'earth3', c2: 'sun3', w: 34, h: 8, y: -1 }, { s: 'cubes', c: 'white', c2: 'earth3', n: 9, w: 32, h: 6, y: -1 }, { s: 'leaves', c: 'grass2', n: 10, w: 32, h: 5, y: -3 }, { s: 'sauce', c: 'white', w: 22, h: 3, y: -5 }, { s: 'wedge', c: 'grass2', c2: 'grass3', x: 17, y: 3 }] },
  ...
  tacos: { vessel: 'boat', layers: [{ s: 'mound', c: 'sun0', c2: 'earth2', w: 34, h: 9, y: -1 }, { s: 'cubes', c: 'sun0', c2: 'earth2', n: 12, w: 32, h: 7, y: -1 }, { s: 'cubes', c: 'sun2', c2: 'sun3', n: 6, w: 30, h: 6, y: -3 }, { s: 'leaves', c: 'grass2', n: 9, w: 32, h: 5, y: -4 }, { s: 'sprinkles', c: 'white', n: 10, w: 30, h: 5, y: -3 }] },
  bajatacos: { vessel: 'boat', layers: [{ s: 'mound', c: 'sun1', c2: 'sun2', w: 34, h: 8, y: -1 }, { s: 'stripes', c: 'sun1', c2: 'sun2', n: 2, w: 30, y: -1 }, { s: 'leaves', c: 'grass3', n: 10, w: 32, h: 6, y: -3 }, { s: 'sauce', c: 'white', w: 22, h: 3, y: -5 }, { s: 'wedge', c: 'grass2', c2: 'grass3', x: 15, y: 3 }] },
